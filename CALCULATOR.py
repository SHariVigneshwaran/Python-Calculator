...
lg = Button(root, text="log", padx=24, pady=10, relief=RAISED, bg="Black", fg="Black")
lg.bind("<Button-1>", sc)
ln = Button(root, text="ln", padx=28, pady=10, relief=RAISED, bg="Black", fg="Black")
ln.bind("<Button-1>", sc)
par1st = Button(root, text="(", padx=29, pady=10, relief=RAISED, bg="Black", fg="Black",command=lambda: click("("))
par2nd = Button(root, text=")", padx=30, pady=10, relief=RAISED, bg="Black", fg="Black",command=lambda: click(")"))
dot = Button(root, text=".", padx=29, pady=10, relief=RAISED, bg="Green", fg="Black",command=lambda: click("."))

exp = Button(root, text="^", padx=29, pady=10, relief=RAISED, bg="Black", fg="Black", command=lambda: click("**"))

degb = Button(root, text="deg", padx=23, pady=10, relief=RAISED, bg="Black", fg="Black")
degb.bind("<Button-1>", sc)
sinb= Button(root, text="sin", padx=24, pady=10, relief=RAISED, bg="Black", fg="Black",)
sinb.bind("<Button-1>", sc)
cosb= Button(root, text="cos", padx=23, pady=10, relief=RAISED, bg="Black", fg="Black")
cosb.bind("<Button-1>", sc)
tanb = Button(root, text="tan", padx=23, pady=10, relief=RAISED, bg="Black", fg="Black")
tanb.bind("<Button-1>", sc)


sqrtm = Button(root, text="Sqrt", padx=23, pady=10, relief=RAISED, bg="Black", fg="Black")
sqrtm.bind("<Button-1>", sc)
ac = Button(root, text="C", padx=29, pady=10, relief=RAISED, bg="Dark Red", fg="Black",command=lambda:clear())
bksp = Button(root, text="DEL", padx=24, pady=10, relief=RAISED, bg="Dark Red", fg="Black",command=lambda: bksps())
mod = Button(root, text=" % ", padx=24, pady=10, relief=RAISED, bg="Black", fg="Black",command=lambda: click("%"))
div = Button(root, text="/", padx=29, pady=10, relief=RAISED, bg="yellow", fg="Black",command=lambda: click("/"))

fact = Button(root, text="x!", padx=29, pady=10, relief=RAISED, bg="Black", fg="Black")
fact.bind("<Button-1>", sc)
seven = Button(root, text="7", padx=30, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("7"))
eight = Button(root, text="8", padx=29, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("8"))
nine = Button(root, text="9", padx=29, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("9"))
mult = Button(root, text="X", padx=29, pady=10, relief=RAISED, bg="Yellow", fg="Black",command=lambda: click("*"))

frac = Button(root, text="1/x", padx=25, pady=10, relief=RAISED, bg="Black", fg="Black")
frac.bind("<Button-1>", sc)
four = Button(root, text="4", padx=30, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("4"))
five = Button(root, text="5", padx=29, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("5"))
six = Button(root, text="6", padx=29, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("6"))
minus = Button(root, text="-", padx=29, pady=10, relief=RAISED, bg="Yellow", fg="Black",command=lambda: click("-"))

pib = Button(root, text="pi", padx=28, pady=10, relief=RAISED, bg="Black", fg="Black")
pib.bind("<Button-1>", sc)
one = Button(root, text="1", padx=30, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("1"))
two = Button(root, text="2", padx=29, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("2"))
three = Button(root, text="3", padx=29, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("3"))
plus = Button(root, text="+", padx=29, pady=10, relief=RAISED, bg="Yellow", fg="Black",command=lambda: click("+"))

e_b = Button(root, text="e", padx=29, pady=10, relief=RAISED, bg="Black", fg="Black")
e_b.bind("<Button-1>", sc)
zero = Button(root, text="0", padx=29, pady=10, relief=RAISED, bg="Grey", fg="Black",command=lambda: click("0"))
